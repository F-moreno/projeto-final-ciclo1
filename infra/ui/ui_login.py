...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.txt_email_login.setObjectName("txt_email_login")
        self.txt_email_login.setGeometry(QRect(22, 159, 221, 31))
        self.txt_email_login.setStyleSheet("background-color: rgba(0, 0, 0, 0.1);")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setText(QCoreApplication.translate("Form", "Salvar", None))
        ...
        self.txt_email_login.setPlaceholderText(
            QCoreApplication.translate("Form", "  Email Corporativo", None)
        )
